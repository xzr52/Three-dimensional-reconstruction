...
if __name__=='__main__':
    ...
    parser.add_argument('--mode', type=str, default='get_masks')
    parser.add_argument('--source_dir', type=str,default='/opt/data/private/nerf_mesh/Voxurf-main/data/scene_01', help='data source folder for preprocess')
